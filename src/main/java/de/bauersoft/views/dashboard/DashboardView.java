package de.bauersoft.views.dashboard;
...
import de.bauersoft.views.dashboard.ServiceHealth.Status;
...
public class DashboardView extends Main {
    ...
    private Component createServiceHealth() {
        ...
        // Grid
        Grid<ServiceHealth> grid = new Grid<ServiceHealth>();
        ...
        grid.addColumn(ServiceHealth::getInput).setHeader("Input").setTextAlign(ColumnTextAlign.END);
        grid.addColumn(ServiceHealth::getOutput).setHeader("Output")
