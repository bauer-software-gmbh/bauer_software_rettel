package de.bauersoft.views.tour.planner;
...
import de.bauersoft.services.tour.TourEntryService;
...
public class TourPlanningView extends Div
{
    ...
    public TourPlanningView(TourService tourService, TourEntryService tourEntryService)
    {
    ...
    private Div createTourLabel(TourEntry entry)
    {
        ...
        wrapper.getElement().setAttribute("title", buildTooltipText(entry));
    ...
    private String buildTooltipText(TourEntry tourEntry)
    {
        Objects.requireNonNull(tourEntry);

        StringBuilder sb = new StringBuilder();
        if(tourEntry.getTimeWindow() != null && !tourEntry.getTimeWindow().isBlank())
        {
            sb.append("Zeitfenster: ").append(tourEntry.getTimeWindow()).append("\n");
        }

        if(tourEntry.getNote() != null && !tourEntry.getNote().isBlank())
        {
            sb.append("Notiz: ").append(tourEntry.getNote());
        }
